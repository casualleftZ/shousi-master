...
public class DBOPenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL ("create table food(f_id int primary key,f_type varchar(16),f_name varchar(12),f_url varchar(100),f_price float,f_dprice float,f_sellcount float," +
                "f_instruction varchar(100))");//菜品表
        db.execSQL("create table shopthing(t_id int primary key,f_name varchar(20),t_num int,t_money,t_money_number)");//购物车表
